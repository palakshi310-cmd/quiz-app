...
*A dynamic web application designed to host real-time quizzes, evaluate user performance, and manage custom question banks.*
- **Tech Stack:** Java (or Python/JavaScript), Object-Oriented Programming (OOPs), Session Management, HTML/CSS
- **Key Features:**
  - **Dynamic Score Tracking:** Engineered backend scoring logic that dynamically evaluates answers, tracks current user states, and calculates final results instantly upon submission.
